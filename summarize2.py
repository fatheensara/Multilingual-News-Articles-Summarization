...
class TransformerBertSummarizer:
    ...
    def summarize_abstractive(self, text , category):
        ...
        summary_ids = self.t5_model.generate(
            ...
            num_beams=5,     # Use higher beams for diversity
            early_stopping=True,
    ...
    def summarize_extractive(self, text, category):
        ...
        # Add category tokens as additional context
        with torch.no_grad():
            ...
            # Calculate relevance scores between category and sentences
